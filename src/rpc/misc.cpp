...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric, optional) the total Ycash balance of the wallet, if wallet functionality is enabled\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"ycashaddress\"\n"
            "\nReturn information about the given Ycash address.\n"
            "\nArguments:\n"
            "1. \"ycashaddress\"     (string, required) The Ycash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"ycashaddress\",   (string) The Ycash address validated\n"
...
UniValue z_validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("z_validateaddress", "\"ys1z7rejlpsa98s2rrrfkwmaxu53e4ue0ulcrw0h4x5g8jl04tak0d3mm47vdtahatqrlknghgfflq\"")
            + HelpExampleRpc("z_validateaddress", "\"ys1z7rejlpsa98s2rrrfkwmaxu53e4ue0ulcrw0h4x5g8jl04tak0d3mm47vdtahatqrlknghgfflq\"")
        );
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are Ycash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) Ycash address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"s1YdUEzTzjYawpW8wkRjwa6tKJPYPvu3CwB\\\",\\\"s1hfWJ4ej1H3s8XCUb7YnrU68K64AsGVUHE\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"s1YdUEzTzjYawpW8wkRjwa6tKJPYPvu3CwB\\\",\\\"s1hfWJ4ej1H3s8XCUb7YnrU68K64AsGVUHE\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"ycashaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"ycashaddress\"    (string, required) The Ycash address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"s1bHiHvZu5x8yprHJbAYZtEYgfHKCdUTmkP\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"], \"chainInfo\": true}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"], \"chainInfo\": true}")
            );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"], \"start\": 1000, \"end\": 2000, \"chainInfo\": true}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"], \"start\": 1000, \"end\": 2000, \"chainInfo\": true}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"], \"start\": 1000, \"end\": 2000}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"smDw2LWkeuJ1NGBDDZvdNbzY8A9D1mkkDZm\"], \"start\": 1000, \"end\": 2000}")
        );

...
bool AsyncRPCOperation_saplingmigration::main_impl() {
    ...
    // If the remaining amount to be migrated is less than 0.01 YEC, end the migration.
...
CAmount AsyncRPCOperation_saplingmigration::chooseAmount(const CAmount& availableFunds) {
    ...
    do {
        ...
        //    - Fast range (when availableFunds > 1 YEC): 8 to 10 inclusive.
        ...
        // 3. Calculate amount := (mantissa * 10^exponent) yoshi.

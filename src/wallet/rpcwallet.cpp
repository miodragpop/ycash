...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (!fEnableGetNewAddress || fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"zcashaddress\"    (string) The new transparent Ycash address\n"
...
UniValue z_converttex(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 1)
        throw runtime_error(
            ...
            "\nConverts a transparent Ycash address to a TEX address.\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"zcashaddress\"  (string, required) The transparent Ycash address to send to.\n"
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 4)
        throw runtime_error(
            ...
            "\nReturns the total amount received by the given transparent Ycash address in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"\" )\n"
            ...
            "Each key is a transparent Ycash address or hex-encoded secp256k1 public key.\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 2))
        throw runtime_error(
            ...
            "that require the availability of private keys, such as sending Ycash.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (params.size() > 2) {
        ...
        for (size_t idx = 0; idx < inputs.size(); idx++) {
            ...
            CTxDestination dest = keyIO.DecodeDestination(destStr);
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Ycash transparent address: ") + destStr);
            }
...
UniValue z_listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (params.size() > 3) {
        ...
        for (const UniValue& o : addresses.getValues()) {
            ...
            if (!zaddr.has_value()) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, string("Invalid parameter, not a valid Ycash address: ") + o.get_str());
            }
...
UniValue z_viewtransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "      \"address\" : \"zcashaddress\",     (string) The Ycash address involved in the transaction. Not included for change outputs.\n"
